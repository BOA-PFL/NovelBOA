       ...
       #find the landings and offs of the FP as vectors
        ...
        for step in range(len(landings))
            try:
                ...
                sdRHeel.append(np.std(dat.RHeel_MeanP[landings[step]:takeoffs[step]])) 
                meanRHeel.append(np.mean(dat.RHeel_MeanP[landings[step]:takeoffs[step]]))
                sdRLatMF.append(np.std(dat.RLatMF_MeanP[landings[step]:takeoffs[step]]))
                meanRLatMF.append(np.mean(dat.RLatMF_MeanP[landings[step]:takeoffs[step]]))
                sdRMedMF.append(np.std(dat.RMedMF_MeanP[landings[step]:takeoffs[step]]))
                meanRMedMF.append(np.mean(dat.RMedMF_MeanP[landings[step]:takeoffs[step]]))
                sdRLatFF.append(np.std(dat.RLatFF_MeanP[landings[step]:takeoffs[step]]))
                meanRLatFF.append(np.mean(dat.RLatFF_MeanP[landings[step]:takeoffs[step]]))
                sdRMedFF.append(np.std(dat.RMedFF_MeanP[landings[step]:takeoffs[step]]))
                meanRMedFF.append(np.mean(dat.RMedFF_MeanP[landings[step]:takeoffs[step]]))
                sdRToes.append(np.std(dat.RToes_MeanP[landings[step]:takeoffs[step]]))
                meanRToes.append(np.mean(dat.RToes_MeanP[landings[step]:takeoffs[step]]))
                maxRHeel.append(np.max(dat.RHeel_MaxP[landings[step]:takeoffs[step]]))
                maxRLatMF.append(np.max(dat.RLatMF_MaxP[landings[step]:takeoffs[step]]))
                maxRMedMF.append(np.max(dat.RMedMF_MaxP[landings[step]:takeoffs[step]]))
                maxRLatFF.append(np.max(dat.RLatFF_MaxP[landings[step]:takeoffs[step]]))
                maxRMedFF.append(np.max(dat.RMedFF_MaxP[landings[step]:takeoffs[step]]))
                maxRToes.append(np.max(dat.RToes_MaxP[landings[step]:takeoffs[step]]))
